"""
Code that runs stock price prediction with sentiment analysis
"""
...
from DataPreprocessing.DataExtraction.extract_stock_data import get_stock_data_v2
...
class PredictionConfig():
    def __init__(self, stock, start_date, end_date, 
        ...
        self.n_layers = n_layers - 2  # Remove two to consider start and end layers
